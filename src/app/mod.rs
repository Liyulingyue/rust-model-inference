...
pub use cli::{
    ...
    validate_qwen3vl_decoder_mode, z_image_cli_options, CliOptions, DSparkOptions,
    DreamXCliOptions, DreamXOptions, DreamXRefinerOptions, EmbeddingOutput, KvFormat,
