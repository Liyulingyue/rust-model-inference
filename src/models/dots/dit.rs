...
mod tests {
    ...
    fn constant_weight(n_in: usize, n_out: usize, value: f32) -> Weight<'static> {
        ...
        let mut weight = Weight::from_quantized(crate::ops::kernel::QuantizedTensor::F32 { data: values, n_in: 0, n_out: 0 });
        weight.n_in = n_in;
        weight.n_out = n_out;
        weight
    }
    ...
    fn separate_adaln_matrices_preserve_branch_and_block_offsets() {
        ...
        data[0] = 1.0;
        let mut weight = Weight::from_quantized(crate::ops::kernel::QuantizedTensor::F32 { data, n_in: 0, n_out: 0 });
        weight.n_in = hidden;
