...
use crate::models::qwen3::asr::model::{validate_qwen3a_source, AudioEmbeddings, Qwen3AudioModel};
...
mod tests {
    use super::*;
    use crate::format::ggufrs::{export_ggufrs, test_support, ExportOptions};
