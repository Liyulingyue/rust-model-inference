...
| Falcon-H1                  | 1.5B       | 文本                 | llama.cpp @ `171e8846b`                | https://modelscope.cn/models/unsloth/Falcon-H1-1.5B-Instruct-GGUF | √ (Experimental；连贯 ChatML/raw 生成 + 逐位 tokenizer 对齐；张量级 Q8 matmul 余 ulp 误差) |
